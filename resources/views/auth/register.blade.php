        ...
        <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg rounded-3xl shadow-2xl p-8">
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-5">
                    ...
                    <input
                        ...
                        required
                        autofocus
                        class="input-field @error('name') border-red-500 dark:border-red-500 @enderror"
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    Sudah punya akun?
                    <a href="{{ route('login') }}" class="text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 font-semibold">
                        Masuk di sini
                    </a>
                </p>
            </div>
