...
<head>
    ...
    <title>@yield('title', 'Toolbox - Semua Tools Online dalam Satu Tempat')</title>
    <meta name="description" content="@yield('description', 'Platform produktivitas all-in-one gratis')">
    ...
    <header class="bg-white/60 dark:bg-gray-900/60 backdrop-blur-xl shadow-sm sticky top-0 z-50 border-b border-gray-200/50 dark:border-gray-800/50">
        <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center space-x-6">
                    <a href="{{ route('home') }}" class="text-gray-700 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 transition font-medium">Beranda</a>
                    <a href="{{ route('categories.index') }}" class="text-gray-700 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 transition font-medium">Kategori</a>
                    @auth
                    <a href="{{ route('favorites.index') }}" class="text-gray-700 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 transition font-medium">Favorit</a>
                    @endauth
                </div>
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div class="hidden md:flex items-center space-x-3">
                        <a href="{{ route('login') }}" class="px-4 py-2 text-gray-700 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 transition font-medium">Masuk</a>
                        <a href="{{ route('register') }}" class="px-6 py-2 bg-gradient-to-r from-primary-600 to-purple-600 text-white rounded-xl hover:shadow-lg transition-all font-medium">Daftar</a>
                    </div>
                    @endauth
        ...
        <div id="mobile-menu" class="hidden md:hidden border-t border-gray-200 dark:border-gray-700 bg-white/95 dark:bg-gray-900/95 backdrop-blur-lg">
            <div class="px-4 py-3 space-y-2">
                <a href="{{ route('home') }}" class="block px-3 py-2 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition">Beranda</a>
                <a href="{{ route('categories.index') }}" class="block px-3 py-2 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition">Kategori</a>
                @auth
                <a href="{{ route('favorites.index') }}" class="block px-3 py-2 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition">Favorit</a>
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                ...
                @else
                <a href="{{ route('login') }}" class="block px-3 py-2 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition">Masuk</a>
                <a href="{{ route('register') }}" class="block px-3 py-2 rounded-lg text-white bg-gradient-to-r from-primary-600 to-purple-600 hover:shadow-lg transition">Daftar</a>
                @endauth
            </div>
        </div>
    </header>
    ...
    <footer class="bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg border-t border-gray-200 dark:border-gray-800 mt-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        <li><a href="{{ route('home') }}" class="text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 transition">Beranda</a></li>
                        <li><a href="{{ route('categories.index') }}" class="text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 transition">Kategori</a></li>
                    </ul>
                </div>
                <div>
            ...
            <div class="text-center pt-8 border-t border-gray-200 dark:border-gray-800">
                <p class="text-gray-600 dark:text-gray-400 text-sm">&copy; {{ date('Y') }} Prasetya Riski Wa'afan. Semua hak cipta dilindungi undang-undang.</p>
