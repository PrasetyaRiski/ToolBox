<?php $__env->startSection('title', 'CSS Minifier - Toolbox'); ?>
...
async function minify() {
    ...
    try {
        const response = await fetch('<?php echo e(route("tools.css-minifier")); ?>', {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kiki4\Documents\belajar web\productivitools\resources\views\tools\coding\css-minifier.blade.php ENDPATH**/ ?>