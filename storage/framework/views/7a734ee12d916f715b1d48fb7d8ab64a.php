...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex items-center justify-between mb-6">
                    ...
                    <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 font-medium">
                        Lupa password?
                    </a>
                </div>
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    Belum punya akun?
                    <a href="<?php echo e(route('register')); ?>" class="text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 font-semibold">
                        Daftar sekarang
                    </a>
                </p>
            </div>
...
<?php /**PATH C:\Users\kiki4\Documents\belajar web\productivitools\resources\views\auth\login.blade.php ENDPATH**/ ?>