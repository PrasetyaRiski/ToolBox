<?php $__env->startSection('title', 'Case Converter - Toolbox'); ?>
...
async function convert(type) {
    ...
    try {
        const response = await fetch('<?php echo e(route("tools.case-converter")); ?>', {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kiki4\Documents\belajar web\productivitools\resources\views\tools\text\case-converter.blade.php ENDPATH**/ ?>