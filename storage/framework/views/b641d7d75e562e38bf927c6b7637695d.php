<?php $__env->startSection('title', 'Base64 Encoder/Decoder - Toolbox'); ?>
...
async function process(action) {
    ...
    try {
        const response = await fetch('<?php echo e(route("tools.base64")); ?>', {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kiki4\Documents\belajar web\productivitools\resources\views\tools\coding\base64-encoder-decoder.blade.php ENDPATH**/ ?>